...
void test_findLast()
{
    ...
    auto t = Utf16W::findLast(r.first, r.second, UTF16W_GREEK_CAPITAL_SIGMA L"i",
                            FindFlags::CASE_INSENSITIVE);
    Y_EQUAL(std::wstring(t.first, t.second), UTF16W_GREEK_SMALL_SIGMA L"I");
...
void test_reverse()
{
    auto s = L"The " UTF16W_GREEK_SMALL_OMEGA UTF16W_COMBINING_BRIDGE_ABOVE
             UTF16W_COMBINING_TILDE L" and the A"
             UTF16W_COMBINING_INVERTED_BREVE UTF16W_COMBINING_DOT_ABOVE L".";
    std::wstring result;
    Y_EQUAL(Utf16W::reverse(s),
            L".A" UTF16W_COMBINING_INVERTED_BREVE UTF16W_COMBINING_DOT_ABOVE
            L" eht dna " UTF16W_GREEK_SMALL_OMEGA
            UTF16W_COMBINING_BRIDGE_ABOVE UTF16W_COMBINING_TILDE L" ehT");
}
...
void test_substring()
{
    ...
    Y_EQUAL(Utf16W::substring(s, 0), L"AB" UTF16W_COMBINING_BRIDGE_ABOVE L"CD");
    Y_EQUAL(Utf16W::substring(s, 0, 4), L"AB" UTF16W_COMBINING_BRIDGE_ABOVE L"CD");
    Y_EQUAL(Utf16W::substring(s, 1, 3), L"B" UTF16W_COMBINING_BRIDGE_ABOVE L"C");
    Y_EQUAL(Utf16W::substring(s, 2, 2), L"");
    Y_EQUAL(Utf16W::substring(s, 3, 1), L"");
    Y_EQUAL(Utf16W::substring(s, 1, -1), L"B" UTF16W_COMBINING_BRIDGE_ABOVE L"C");
    Y_EQUAL(Utf16W::substring(s, 2, -2), L"");
    Y_EQUAL(Utf16W::substring(s, 3, -4), L"");
    Y_EQUAL(Utf16W::substring(s, -3), L"B" UTF16W_COMBINING_BRIDGE_ABOVE L"CD");
    Y_EQUAL(Utf16W::substring(s, -3, -1), L"B" UTF16W_COMBINING_BRIDGE_ABOVE L"C");
    Y_EQUAL(Utf16W::substring(s, -2, -2), L"");
...
void test_trimEnd()
{
    Y_EQUAL(Utf16W::trimEnd(L" \n\t foo bar \f\r" UTF16W_PARAGRAPH_SEPARATOR),
            L" \n\t foo bar");
    Y_EQUAL(Utf16W::trimEnd(L":--." UTF16W_GREEK_SMALL_SIGMA L"foo bar:--",
                            Unicode::isPunctuation),
...
void test_trimStart()
{
    Y_EQUAL(Utf16W::trimStart(L" \n\t" UTF16W_PARAGRAPH_SEPARATOR L" foo bar \f "),
            L"foo bar \f ");
    Y_EQUAL(Utf16W::trimStart(L":--." UTF16W_GREEK_SMALL_SIGMA L"foo bar:--",
                              Unicode::isPunctuation),
            UTF16W_GREEK_SMALL_SIGMA L"foo bar:--");
}

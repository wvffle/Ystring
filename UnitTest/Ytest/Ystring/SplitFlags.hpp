...
struct SplitFlags
{
    /** @brief The flags that can be passed to the various split-functions.
      */
    enum Type
    {
        ...
        /** @brief Don't include an empty part in the result where the string
          *     contains two consecutive separators.
          */
        ...
        /** @brief Don't include the remainder in the result after the
          ...
          * only interested in a few tokens at the start or end of a string.
          */

...
{
    attributeValue(Ystring::Utf8::toUtf8(value, Ystring::Encoding::UTF_16));
}
...
{
    attribute(name, Ystring::Utf8::toUtf8(value, Ystring::Encoding::UTF_16));
}
...
{
    element(name, Ystring::Utf8::toUtf8(charData, Ystring::Encoding::UTF_16));
}
...
{
    characterData(Ystring::Utf8::toUtf8(charData, Ystring::Encoding::UTF_16));
}

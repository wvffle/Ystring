...
{
    Y_ASSERT(Utf8::caseInsensitiveEqual("aBc" UTF8_GREEK_SMALL_SIGMA,
                                        "AbC" UTF8_GREEK_CAPITAL_SIGMA));
    Y_ASSERT(!Utf8::caseInsensitiveEqual("aBc&8q" UTF8_GREEK_SMALL_SIGMA,
                                         "AbC&8p" UTF8_GREEK_CAPITAL_SIGMA));
}

void test_caseInsensitiveLess()
{
    Y_ASSERT(!Utf8::caseInsensitiveLess("aBc" UTF8_GREEK_SMALL_SIGMA "D",
...
void test_escape_BACKSLASH_ASCII_SMART()
{
    ...
    Y_EQUAL(Utf8::escape("\xc4\x80", EscapeType::BACKSLASH_ASCII_SMART),
             "\\u0100");
    Y_EQUAL(Utf8::escape("\xef\xbf\xbf", EscapeType::BACKSLASH_ASCII_SMART),
             "\\uFFFF");
...
void test_getCodePoint()
{
    ...
    Y_EQUAL(Utf8::getCodePoint(str, -3), Unicode::COMBINING_INVERTED_BREVE);
...
{
    Y_EQUAL(Utf8::replace("123 foo 456 foo 789 foo 012", "foo", "bar", -2),
...
void test_replaceInvalidUtf8InPlace()
{
    ...
    Y_EQUAL(Utf8::replaceInvalidUtf8InPlace(s), "ABC??DEF\xD0\x80?GH??I?");
}
...
void test_substring()
{
    ...
    Y_EQUAL(Utf8::substring(s, 0), "AB" UTF8_COMBINING_BRIDGE_ABOVE "CD");
    Y_EQUAL(Utf8::substring(s, 0, 4), "AB" UTF8_COMBINING_BRIDGE_ABOVE "CD");
    Y_EQUAL(Utf8::substring(s, 1, 3), "B" UTF8_COMBINING_BRIDGE_ABOVE "C");
    Y_EQUAL(Utf8::substring(s, 2, 2), "");
    Y_EQUAL(Utf8::substring(s, 3, 1), "");
    Y_EQUAL(Utf8::substring(s, 1, -1), "B" UTF8_COMBINING_BRIDGE_ABOVE "C");
    Y_EQUAL(Utf8::substring(s, 2, -2), "");
    Y_EQUAL(Utf8::substring(s, 3, -4), "");
    Y_EQUAL(Utf8::substring(s, -3), "B" UTF8_COMBINING_BRIDGE_ABOVE "CD");
    Y_EQUAL(Utf8::substring(s, -3, -1), "B" UTF8_COMBINING_BRIDGE_ABOVE "C");
    Y_EQUAL(Utf8::substring(s, -2, -2), "");

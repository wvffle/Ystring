...
namespace Ystring
{
    ...
    static EncodingName s_EncodingMap[] = {
        ...
        EncodingName("latin9", Encoding::LATIN_9),
        EncodingName("latin-9", Encoding::LATIN_9),
        EncodingName("iso8859-15", Encoding::LATIN_9),
        EncodingName("iso-8859-15", Encoding::LATIN_9),
        ...
        EncodingName("cp437", Encoding::CP_437),
        EncodingName("oem437", Encoding::CP_437),
        EncodingName("cp850", Encoding::CP_850),
    ...
    static EncodingInfo s_Properties[] = {
        ...
        EncodingInfo(Encoding::WINDOWS_1252, "windows-1252", "",
                     Endianness::UNKNOWN, 1, 1, 1),
        EncodingInfo(Encoding::CP_437, "CP437", "",
                     Endianness::UNKNOWN, 1, 1, 1),
        EncodingInfo(Encoding::CP_850, "CP850", "",
                     Endianness::UNKNOWN, 1, 1, 1),

...
/** @brief Returns true if @a c is a letter that is lowercased, uppercased or
  *     titlecased.
  */
...
/** @brief Returns true if @a c is a character that can be drawn in any way.
  */
...
/** @brief Returns true if @a c is among the hexadecimal digits (0-9 and A-F).
  */

...
struct Encoding
{
    enum Type
    {
        /** @brief Returned by determineEncoding when the character set can
          *     not be identified.
          */
        UNKNOWN,
        ...
        /** @brief UTF-8 encoding.
          */
        UTF_8,
        /** @brief ASCII extended with most characters used in Western Europe.
          */
        ISO_8859_1,
        ...
        /** @brief An undetermined 8-bit character set.
          *
          * Returned by determineEncoding when the character set appears to
          * be an 8-bit encoding, but is not ASCII or UTF-8.
          */
